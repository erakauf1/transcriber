...
3. Clean up the transcript with `gpt-4o` (remove filler words, fix grammar, tighten sentences)
...
No backend, no accounts. The app calls OpenAI directly from your browser.

1. Open the app and tap **Settings**
2. Paste your [OpenAI API key](https://platform.openai.com/api-keys) — it's stored in your browser's localStorage and never leaves your device
...
| `src/cleanup.js` | OpenAI chat completion for transcript cleanup |
